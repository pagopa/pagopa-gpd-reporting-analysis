...
import it.gov.pagopa.reporting.model.AppInfo;
...
class InfoTest {
    ...
    void getInfoOk() {
        ...
        // Mocking service creation
        Logger logger = Logger.getLogger("example-test-logger");
        String path = "/META-INF/maven/it.gov.pagopa.reporting/reporting-analysis/pom.properties";
    ...
    void getInfoKo() {
        ...
        // Mocking service creation
        Logger logger = Logger.getLogger("example-test-logger");
        String path = "/META-INF/maven/it.gov.pagopa.reporting/reporting-analysis/fake";
